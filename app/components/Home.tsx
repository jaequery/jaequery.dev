    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-900 text-sm">
      <header className="px-4 h-12 flex items-center border-b border-gray-200">
        ...
        <nav className="ml-auto flex gap-4">
          ...
          {/* <Link className="hover:underline underline-offset-4" to="#experience">
            Experience
          </Link> */}
          <Link className="hover:underline underline-offset-4" to="#skills">
            What I do
          </Link>
      ...
      <main className="flex-1 px-4 py-8 max-w-3xl mx-auto w-full">
        ...
        <section id="contact">
          ...
          <div className="flex space-x-2">
            ...
            <Link
              to="https://linkedin.com/in/jaequery"
              className="p-2 border border-gray-200 rounded hover:bg-gray-100"
            >
